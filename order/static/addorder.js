        ...
        $("table tbody tr").last().after(
            '<tr>'+
                        ...
                        '<td><select class="form-control" name="units[]" id="">'+
                            ...
                            '<td><input  class="form-control" type="text" name="vehicle_no[]"></td>'+
                            '<td class="text-center"><label class="form-control" style="cursor: pointer;"><i class="fa-solid fa-upload"></i>'+
                            '<input type="file" name="weight[]" style="display: none;"></label></td>'+
            '</tr>'
        );
    });
